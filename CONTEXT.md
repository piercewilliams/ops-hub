...
| 2 | Dashboard Instrumentation | 4 | In progress | PTECH-7641 DONE. **WordPress send-to WP LIVE 2026-04-09** (UsW/WW/SOD/Bargain Hunter). **PGS-82 fixes pushed 2026-04-13** (Marcelo); Oliver integrating to production. **PGS-140 further along** — bug found/fixed; needs Amplitude data test + push for review. **PTECH-7730 (TO DO, PT Delta, unassigned)** = p-tagging fix — blocks Amplitude adapter + Deedra Sigma dash. Amplitude connector connected 2026-04-11. Release schedule (staging + production dates) incoming from Susannah/Oliver/Saner. |
