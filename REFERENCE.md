...
|--------|--------|-------|-------|
| PGS-140: Duplicate Content (Differentiation) Analytics | **Selected for dev** | Track pass/fail rate, failing variant pairs, reanalysis clicks, CSA auto-regeneration events. Feeds P2 Amplitude adapter once live. @Pierce Williams + @Jim Robinson tagged. Susannah's "later this week" priority. |
