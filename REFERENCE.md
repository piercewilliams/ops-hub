...
| PGS-184: National Team: Make Keywords Input Field Mandatory | **BACKLOG (2026-04-15)** | CSA eng | New ticket. |
| PGS-174: National Keywords | **BACKLOG epic (2026-04-15)** | CSA eng | New BACKLOG epic. Separate from PGS-111. |
| PGS-111: All Teams: SEO Metadata Fields Not Displayed at Step 3 for Content Format Variants | **CODE REVIEW (2026-04-15)** | CSA eng | Bug: seo title, meta description, seo keywords not visible at Step 3 when a Content Format is selected. Confirmed missing: Discovery, What to Know. All other Content Formats to be checked. Root cause: PGS-88 (v0.82.0) didn't extend to Content Format variant types. Blocks PGS-104 QA (one AC). Victor Suarez resuming full PGS-104 after PGS-111 complete. |
| PGS-104: Add keywords input field + downstream enforcement to Research Draft | **IN PROGRESS (2026-04-15 standup)** | Victor Suarez (dev); Jonathan Gonzalvo (QA) | Strategy: merge PR #107, address further issues as separate hotfix. Oliver Felix helping test + deploy. Victor resumes after PGS-111 complete. Blocked AC: keywords reflected in seo keywords field at Step 3 (depends on PGS-111). Spec: first comma-sep term = primary keyword; rest = secondary. Primary must appear in H1 (front-loaded, first 8 words), meta title, dek, meta description, lede. |
