...
export const PROJECTS = {
  ...
  'p6-taxonomy': {
    ...
    description: 'Strategy settled: Canonical ID = Cluster ID; articles are siblings. EGS-127 (Marcelo, 4 subtasks) replaces PGS-40 — tracks which variants came from which canonical article. Susannah\'s #1 analytics priority (one editor manually tracking 700+ stories/month). Dev team owns execution.',
    blockers: [],
    nextActions: [
      'Monitor EGS-127 (Marcelo Freitas)',
  ...
  'p2-dashboard': {
    ...
    adapters: [
      ...
      { name: 'Amplitude', status: 'pending-creds', note: 'Blocked on CSA eng p-tagging bug (CUE/WP mismatch). Activate once fixed.' },
    ],
    blockers: [
  ...
  'p4-governance': {
    ...
    description: '5 National team personas sent to Susannah (PGS-133 in Code Review). AGENT-AUDIENCE §1 routing live. Active Jira: PGS-134 READY FOR PRODUCTION; PGS-135/141/147/148 in Code Review; PGS-139 in dev; PGS-150 in Product Review. SmartNews/Apple News format guide received — 10 corrections needed, Andy sign-off still pending.',
    blockers: [
