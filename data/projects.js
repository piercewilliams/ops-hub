...
export const COMPLETED_TASKS = [
  { date: '2026-04-15', task: 'Pierce granted CSA Admin role by Susannah Locke (2026-04-15). Susannah entered 2 of 5 National Team personas as Team Target Audiences in CSA production: The Discover Browser + The Wonder-Driven Science Enthusiast. Admin feature allows team-shared audiences visible to all National Team accounts. Pierce to enter remaining 3: The Curious Optimizer, The Curious Explorer, The Watercooler Insider. Workflow documented: CSA production → National Team → Import Draft (fastest path to Target Audiences) → Step 3 → scroll to Team Target Audiences → Add another team target audience → paste Name, Why this audience cares, Focus Areas → leave Auto-select unchecked → Save. Reference: Confluence Tango walkthrough + Google Doc recording (Gemini notes, 5 min demo 1:39pm EDT).', project: '#4 Article Format + Persona + Keyword Governance' },
