...
export const PROJECTS = {
  ...
  'p2-dashboard': {
    ...
    owner: 'Pierce',
    description: 'Live data ingestion layer for csa-dashboard. Manual bridge active. PTECH-7641 done. PGS-140 IN PROGRESS (Marcelo). p-tagging fix now ticketed: PTECH-7730 (TO DO, Platform Technology team, unassigned) — when done enables Amplitude adapter AND unified Sigma dashboard across L&E + CUE. Sigma CSA dash: Deedra building simple PV/SubPV version first — watch for it to ship before requesting additional dimensions.',
    adapters: [
