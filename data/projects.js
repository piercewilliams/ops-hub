...
export const PROJECTS = {
  ...
  'p10-gary': {
    ...
    description: 'Gary Kirwan\'s toolkit — reframed as cross-pipeline nodes (2026-04-10). Meeting held 2026-04-13 (~15 min, Google Meet). KEY: Gary confirmed NO plagiarism detection built internally — uses Originality.ai + Winston AI as external reference tools. Copyscape recommendation stands. Confidence scoring = claim-level (individual claims categorized → overall score); deterministic mechanism (scrapes actual source markdown for hard proof). Code access pending Jason Smith + Rajiv discussion. BATCH TEST IN PROGRESS (2026-04-13): tests/batch_validate.py submitted all 15 Sara Vallone articles via data-validity API. Article 1 result: MOSTLY_TRUE, confidence 0.78, 9 claims. Key finding: Gary\'s verdict taxonomy includes MOSTLY_TRUE + MIXED (not in Chris\'s 5-term spec) — alignment needed with Sara.',
    blockers: [
      'Code access — Gary discussing with Jason Smith + Rajiv; committed to Slack response on method.',
      'Sara Vallone parameter session — walk 15 test articles; compile results first. Timing TBD.',
    ],
    nextActions: [
      'Compile batch test results from data/test-results-2026-04-13.json and summarize for Sara Vallone meeting',
      'Align on Gary\'s extended verdict vocabulary (MOSTLY_TRUE, MIXED) vs. Chris\'s 5-term spec before Sara session',
