...
export const PROJECTS = {
  ...
  'p9-prd': {
    ...
    name: 'PRD Revisions',
    owner: 'Pierce',
    description: 'CURRENT #1 PRIORITY (Chris Palo, 2026-03-30). Synthesize a unified PRD that: (1) pulls what\'s still valid from the existing PRD — scrap what doesn\'t fit, (2) incorporates what\'s relevant from the "Content Graph & Operations Layer V3 Breakout" doc (surrounding infrastructure vision), and (3) adds the missing piece — a documented ideal end state for the CSA itself: what it should ultimately be and do, how input signals govern generation, what the output standard is, how it connects to distribution and performance feedback. The dev team currently lacks a clear picture of the CSA\'s own ideal end state and is building half-steps toward an undefined goal. Draft due end of week (2026-04-03).',
    status_detail: 'Draft due 2026-04-03. Do not wait for P8 or P13. Three source inputs: (1) existing PRD, (2) Content Graph & Operations Layer V3 Breakout doc, (3) Pierce\'s own understanding from standups, PGS-82, Chris 1:1, and the "control room" model.',
    blockers: [],
    nextActions: [
      'Block calendar time immediately — target end-of-week draft (2026-04-03)',
      'Read existing PRD — annotate what to keep, what to cut',
      'Pull relevant sections from Content Graph & Operations Layer V3 Breakout (surrounding infrastructure) — note open questions that need Pierce/Chris input',
      'Write the missing section: CSA ideal end state — input signals, how personas/formats/keywords govern generation from the start, output standards, feedback loop from distribution performance back into future generation',
      'Document the "control room" model: trend signals → CSA generation → review/greenlight → distribution → performance feeds back in; United Robots as auto-flow tier',
      'Align with Chris and Sarah Price — their views of the ideal state may differ from Pierce\'s',
      'Address V3 Breakout open questions where Pierce has a position (esp. Operations Layer ownership, SLA thresholds)',
    ],
    dependsOn: [],
  },
