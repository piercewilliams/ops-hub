...
export const PROJECTS = {
  ...
  'p9-prd': {
    ...
    nextActions: [
      ...
      'Add backlinking use case rationale — borrow "flare or credibility" from well-performing evergreen pieces (clarified by Sarah Price 2026-04-03)',
  ...
  'p3-headlines': {
    ...
    nextActions: [
      'Get SEMrush API key + 250K credits from Sarah Price (confirmed on 2026-04-03a alignment call — she will forward)',
      '3-way meeting next week (Pierce, Sarah Price, Sara Vallone) — align on what SEMrush signals/trends to track and how to present them',
      'Build SEMrush layer on top of API in T1 analysis environment — point-and-click signal tracking for Sarah without requiring her to touch the API',
