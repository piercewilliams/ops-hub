...
export const PROJECTS = {
  ...
  'p18-agentic-writing': {
    ...
    nextActions: [
      'Attend Thu 2026-04-16 11am CDT meeting — listen for pain points, identify pilot author candidate, do not pitch solutions',
      'After meeting: Pierce + Sara huddle to prioritize pain points and pick pilot author',
  ...
  'p20-experiences-test': {
    ...
    compassGoal: 'G5 — Professional Development: Technical & Editorial Fluency',
    description: 'Sara Vallone\'s 2-week Experiences vertical content test. Pierce provided keyword data via SEMrush API (Apr 2026) for 4 topics: Landmarks (GO HARD — 1.5M/mo head term, KD 34, geographic variants KD 12–27), 5-Day Travel / Short Trips (GO HARD — avg KD 15, destination itineraries KD 4–9, very winnable), Solo Dining (SKIP — volume ceiling 260/mo, $0 CPC, not a search opportunity), Scenic Road Trips (GO HARD — 8,100/mo, KD 26, no major travel publishers ranking). No McClatchy publication ranks for any keyword across all 4 topics. Sara\'s teams will test content production; Pierce monitors results. Critical feedback loop at end: cross-check which topics Sara published vs. skipped against actual article performance — used to calibrate Go Hard/Skip verdict thresholds in data-keywords tool. This is the first live calibration input for the keyword verdict system. Deliverables in data-keywords/reports/: 4 per-topic xlsx files (KD color-coded, portfolio gap flags, competitor sections) + 1 docx analytical report (full verdict framework + methodology).',
    blockers: [
