...
export const PROJECTS = {
  ...
  'p3-headlines': {
    ...
    nextActions: [
      ...
      'Headline grading tool (committed 2026-04-06 C&P Weekly): once Sara Vallone + Sarah Price define required parameters/criteria, build (1) automated daily headline quality report and (2) hub page evaluating last 24-48hrs of headlines. Tool to eventually integrate into CSA.',
    ],
    dependsOn: ['p1-access'],
  },
