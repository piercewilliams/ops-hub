...
export const PROJECTS = {
  ...
  'p14-semrush': {
    ...
    blockers: [
      'Go Hard/Test Small thresholds undefined — needs Rocky + Sarah session (not Pierce\'s judgment call alone)',
    ...
    systems: [
      ...
      { name: 'SEMrush API', status: 'done', note: 'API key confirmed direct from Rocky 2026-04-14. No automation until credit rates confirmed (Rocky/Julio).' },
      { name: 'DataForSEO API', status: 'pending', note: 'Cheaper alternative flagged by Rocky — evaluate for batch use.' },
    ],
    contacts: [
      { name: 'Rocky Rhodes', role: 'SEMrush admin; API key source; liaising with rep Julio on credit rates' },
      { name: 'Chad Bruton', role: 'Snowflake/Sigma — walkthrough 2026-04-15 1:30pm CDT' },
