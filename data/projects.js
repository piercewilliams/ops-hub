...
export const PROJECTS = {
  ...
  'p9-prd': {
    ...
    name: 'PRD Revisions',
    owner: 'Pierce',
    description: 'CURRENT #1 PRIORITY (Chris Palo, 2026-03-30). The PRD is the "Content Graph & Operations Layer V3 Breakout" doc from Rajiv\'s team. It documents the surrounding infrastructure (Content Graph, Operations Layer) but has no section on what the CSA itself should ultimately be and do. Pierce\'s job is to write that missing piece — with Claude\'s help — and add it to the document. The dev team lacks a clear picture of the CSA\'s own ideal end state and is building half-steps toward an undefined goal. Draft due end of week (2026-04-03).',
    status_detail: 'Draft due 2026-04-03. Task = write the CSA ideal end state section and add it to the V3 Breakout doc. Source material: Chris\'s "control room" model from 1:1, Pierce\'s understanding from standups and PGS-82, Chris and Sarah Price\'s perspectives.',
    blockers: [],
    nextActions: [
      'Block calendar time — target end-of-week draft (2026-04-03)',
      'Work with Claude to draft the CSA ideal end state section: input signals, how personas/formats/keywords govern generation from the start, output standards, feedback loop from distribution performance back into future generation',
      'Document the "control room" model as the CSA\'s role in the larger system: trend signals → CSA generation → review/greenlight → distribution → performance feeds back in',
      'Integrate with the V3 Breakout doc — the new section should connect cleanly to Content Graph and Operations Layer',
