...
export const PROJECTS = {
  ...
  'p1-access': {
    ...
    systems: [
      ...
      { name: 'Amplitude', status: 'pending', note: 'Access pending — needs provisioning to the right Amplitude group. Separate issue: the CSA eng team has a p-tagging bug (CUE/WP tag format mismatch) that affects data quality; that is their fix to make, not a Pierce action item.' },
    ...
    nextActions: [
      ...
      'Get Amplitude API access — confirm provisioning path with IT or Chad (which group to be added to)',
