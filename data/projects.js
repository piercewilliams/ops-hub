...
export const PROJECTS = {
  ...
  'p6-taxonomy': {
    ...
    description: 'Cluster tagging strategy SETTLED as of 2026-04-01 alignment meeting. Canonical ID = Cluster ID (session ID linking sibling variants). CSA articles are SIBLINGS. TAXONOMY TICKET RESTRUCTURED (2026-04-07): original ticket closed, reopened as an epic with ~7 new tickets. Siblings still in scope — will flow through CMS → Snowflake → Amplitude as soon as CMS connections are established. Performance: national team at 1-in-3.3 stories-per-cluster ratio as of 2026-04-07 (target: 1-in-4 — already exceeded). Chris showed examples: Netflix One Piece cluster landed on Miami + Kansas City. Tracking still painful without tagging live. Chris sharing sanitized data with Kathy + Eric. FUTURE: Chris proposed daily AB testing of templates as a future product feature (content creators unaware of test group).',
