...
export const PROJECTS = {
  ...
  'p1-access': {
    ...
    systems: [
      ...
      { name: 'CSA GitHub repo', status: 'pending', note: 'Susannah Locke got OK for Pierce to view codebase (2026-04-06). Pierce provided GitHub username: piercewilliams. Awaiting Susannah/dev team to provision access.' },
    ],
    blockers: [
  ...
  'p10-gary': {
    ...
    nextActions: [
      ...
      'Build integration spec: editor correction + override, error rate tracking by article/author/content type, override reporting (Pierce + Vallone + Chris initially)',
  ...
  'p9-prd': {
    ...
    name: 'PRD Revisions',
    owner: 'Pierce',
    description: 'COMPLETE. PRD V0.4 delivered to Chris Palo 2026-04-06 for final review. Sara Vallone + Sarah Price feedback fully incorporated. Syndication ecosystem taxonomy (app-based captured vs. web-based competitive), LTV=0 framework, swarm testing (Phase 2/3 product req), standalone testing module, and evergreen backlinking use case all added. V0.4 docx on Desktop; live in Google Docs.',
    blockers: [],
    nextActions: [
      'Await Chris Palo final review and feedback on V0.4',
    ],
    dependsOn: [],
  },
  ...
  'p4-governance': {
    ...
    description: '5 personas sent to Susannah Locke to pin for all National accounts (2026-04-03): Discover Browser (already saved), + 4 additional ticketed in PGS-133. AGENT-AUDIENCE routing confirmed live across all of §1 (2026-04-08): general-style (§1.1, §1.3, §1.4 link count/anchor text — Susannah UI uploads), headline (§1.2 via PGS-141), seo (§1.2 via PGS-148), human-only (§1.4 What to Link To + §1.5–1.9 — no action needed). Susannah using Claude to fetch content by tag during uploads. H1 headline enforcement (80–100 chars) ticketed PGS-135. Sara Vallone\'s SmartNews/Apple News format guide received 2026-04-03 — includes 2 new personas: SmartNews Skimmer + Apple News Explorer. Evidence report: 10 corrections needed before codification. Andy review still required before personas go to Susannah. Pairwise testing approach confirmed: ~3 formats × 3 personas = ~9 tests.',
    status_detail: 'In progress. All 5 National team personas sent to Susannah 2026-04-03. PGS-133 (4 additional target audiences) now in Code Review. PGS-134 (Everything to Know + FAQ/Service Journalism formats) in progress. PGS-135 (H1 headline 80–100 char enforcement) selected for dev. PGS-141 (H1 rules for National Team agent prompt) Done — AGENT-AUDIENCE: headline live. PGS-147 (intro length ~80–100 words for National team) new ticket. PGS-148 (SEO fields) Done — AGENT-AUDIENCE: seo live. AGENT-AUDIENCE routing confirmed live across all of §1 (2026-04-08): general-style (§1.1, §1.3, §1.4 link count/anchor), headline (§1.2 PGS-141), seo (§1.2 PGS-148), human-only (§1.4 What to Link To + §1.5–1.9 — no action needed). Susannah using Claude to fetch content by tag during uploads. Apple News + Smart News format guide received — Andy review still needed before codification.',
    blockers: [
