...
export const PROJECTS = {
  ...
  'p10-gary': {
    ...
    blockers: [
      'Gary will not share API endpoint — has it ready but chooses to run documents himself; disposition issue, not just unresponsiveness (confirmed 2026-04-07)',
      'Chris told Jason (Smith) about Gary\'s reluctance to share code (2026-04-07)',
      'Sara Vallone following up directly (2026-04-08) asking Gary to send endpoint info',
      'Sara Vallone meeting (next week) needed to finalize verdict taxonomy and run through test articles — gated on Gary sharing access',
    ],
    nextActions: [
      'Monitor Sara Vallone follow-up with Gary — if no response, escalate to Chris again',
