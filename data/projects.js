...
export const PROJECTS = {
  ...
  'p1-access': {
    ...
    nextActions: [
      ...
      'Gary Kirwan: Chris Palo now personally following up',
      'Await CSA GitHub access from Susannah — no action needed; she has the username',
    ],
    dependsOn: [],
  },
  ...
  'p10-gary': {
    ...
    nextActions: [
      'Await Chris Palo\'s direct follow-up with Gary — no additional Pierce action needed to initiate; monitor for resolution',
      'DONE: CSA fact-checking ruleset v0.1 drafted (2026-04-07) — verdict taxonomy, source authority tiers, content-type rules, escalation logic, override documentation format. 4 open items for Rajiv/Susannah.',
      'Run Sara Vallone parameter session next week — walk 15 test articles she sent; arrive with v0.1 ruleset for iteration',
  ...
  'p3-headlines': {
    ...
    nextActions: [
      ...
      'Receive updated cluster performance data + manual Amplitude pulse data from Sarah Price — analyze to determine which sites, content types, authors are most worth team time and resources',
      'Headline Grader: live + delivered (2026-04-06). Monitor Sara Vallone + Sarah Price feedback on criteria; refine rule tiers in generate_grader.py as input comes in.',
      'Individual performance tracking (C&P Weekly request): add per-author breakdown to Headline Grader — identify writers who consistently beat tool suggestions. Author field already in Sara\'s Tracker sheet.',
    ],
    dependsOn: ['p1-access'],
  },
