...
export const PROJECTS = {
  ...
  'p3-headlines': {
    ...
    description: '8 findings live as of 2026-04-01 — Apple News, SmartNews, MSN, Yahoo headline performance + ANP full-universe data (Jan–Feb 2026, 8 publications, 80K articles). Findings 6–8 added from ANP analysis: Featuring Reaches Non-Subscribers, Topic Predicts Featuring, ANP bottom-performer structural patterns (section tagging, local sports, national wire). Playbook at 4 tiles (Section Tagging + Local vs. National added 2026-04-01). Weekly ANP drops from Tarrow established. Site previewed on Slack; direct link not yet shared with Sarah Price. O&O/Amplitude layer (Chris Palo request) is a separate sub-workstream requiring Amplitude access.',
    blockers: [
      'O&O/Amplitude layer blocked by Amplitude access (P1) — treat as separate workstream, do not block core work',
    ],
    nextActions: [
      'Share site with Sarah Price — she has seen the Slack preview but has not received the direct link yet',
      'Share "What to know" Featured rate findings (Finding 1) → editorial leads',
      'ANP March drop: Tarrow to add to Drive folder (2026-04-01); ingest into anp_data/ when it arrives',
